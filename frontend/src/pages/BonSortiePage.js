...
export default function BonSortiePage() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const msg = e?.response?.data?.message || 'Erreur lors de la création du bon de sortie';
      setError(msg);
    }
  };
  ...
  return (
    <div className="container py-4">
      <h2 className="mb-3">Créer un bon de sortie</h2>
      ...
      <form onSubmit={onSubmit} className="card p-3 shadow-sm">
        ...
        <div className="mb-3">
          <div className="d-flex justify-content-between align-items-center mb-2">
            <label className="form-label mb-0">Produits à sortir</label>
        ...
        <button type="submit" className="btn btn-primary">Créer le bon de sortie</button>
      </form>
    </div>
  );
}
